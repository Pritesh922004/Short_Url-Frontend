            ...
            <div className="flex items-center justify-center min-h-screen">
                <div className="w-full relative my-auto max-w-md mx-auto p-8 bg-white rounded-xl shadow-lg animate-[fadeIn_0.5s_ease-in-out] border-2 border-gray-200">
                    <div className="text-center">
                        ...
                        <Link
                            to="/signin"
                            className="inline-block w-full sm:w-auto px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
                        >
                            Sign In Now
                        </Link>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`block w-full pl-10 pr-3 py-2.5 border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300`}
                                placeholder="John Doe"
                            />
                        </div>
                        {errors.name && (
                            <p className="mt-1 text-sm text-red-600 animate-[fadeIn_0.3s_ease-in-out]">{errors.name}</p>
                        )}
                    </div>
